...
public final class EntityTracker {
    ...
    public static void forEach(@NotNull ServerLevel level, long chunkPos, Identifier filter, Consumer<Entity> consumer) {
    ...
    public static void forEach(@NotNull ServerLevel level, long chunkPos, int sectionIndex, Identifier filter, Consumer<Entity> consumer) {
